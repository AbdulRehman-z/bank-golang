...
// Source: github.com/AbdulRehman-z/bank-golang/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 db.CreateUserRequest) (db.User, error) {
	m.ctrl.T.Helper()
